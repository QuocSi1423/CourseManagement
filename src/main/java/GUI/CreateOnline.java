 ...
 * @author ADMIN
 */
public class CreateOnline extends javax.swing.JFrame {

    /**
     * Creates new form CreateOnline
     */
    public CreateOnline() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(811, 330));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateOnline.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateOnline().setVisible(true);
            }
        });
    }
